    ...
    public class InvoiceAttachmentService : IInvoiceAttachmentService
    {
        ...
        public async Task AddInvoiceAttachmentsAsync(Guid invoiceId, List<int> fileIds)
        {
            if (invoiceId == Guid.Empty)
                throw new BusinessException(400, "https://tools.ietf.org/html/rfc7231#section-6.5.1", "One or more validation errors occurred.", "InvoiceId is required.");

            if (fileIds == null || !fileIds.Any())
                throw new BusinessException(400, "https://tools.ietf.org/html/rfc7231#section-6.5.1", "One or more validation errors occurred.", "FileIds are required.");
        ...
        {
            if (fileId <= 0)
                throw new BusinessException(400, "https://tools.ietf.org/html/rfc7231#section-6.5.1", "One or more validation errors occurred.", "FileId is required.");
